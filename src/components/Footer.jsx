...
export default function Footer() {
  return (
    <footer className="bg-black rounded-lg mt-0 shadow-lg border-t border-gray-700">
      <div className="container flex flex-col mx-auto">
        <div className="flex flex-col items-center w-full my-12 md:my-20">
          ...
          <div className="flex flex-col items-center gap-4 md:gap-6 mb-6 md:mb-8">
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-5 lg:gap-12 gap-y-2 lg:flex-nowrap">
              <a href="#about" className="text-gray-400 hover:text-white transition text-sm md:text-base">About</a>
              <a href="#features" className="text-gray-400 hover:text-white transition text-sm md:text-base">Features</a>
              <a href="#blog" className="text-gray-400 hover:text-white transition text-sm md:text-base">Blog</a>
              <a href="#resources" className="text-gray-400 hover:text-white transition text-sm md:text-base">Resources</a>
              <a href="#partners" className="text-gray-400 hover:text-white transition text-sm md:text-base">Partners</a>
              <a href="#help" className="text-gray-400 hover:text-white transition text-sm md:text-base">Help</a>
              <a href="/terms" className="text-gray-400 hover:text-white transition text-sm md:text-base">Terms</a>
            </div>
          ...
          <div className="flex items-center">
            <p className="text-sm md:text-base font-normal leading-7 text-center text-gray-400">
